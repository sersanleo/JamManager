...
public class JamResourceUITest {
	...
	public void testCreateJamResourceNotDownloadURL() throws Exception {
		...
		assertEquals("no puede estar vacío",
				driver.findElement(By.xpath("//form[@id='jamResource']/div/div[2]/div/span[2]")).getText());
		LogOut();
	}
	...
	public void testCreateJamResourceNotDescription() throws Exception {
		...
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		assertEquals("no puede estar vacío",
				driver.findElement(By.xpath("//form[@id='jamResource']/div/div/div/span[2]")).getText());
		LogOut();
	}
