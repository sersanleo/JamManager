...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/jams/new", "/jams/*/edit", "/jams/*/delete", "/jams/*/jamResources/**")
				.hasAnyAuthority("jamOrganizator")
				.antMatchers("/jams", "/jams/*").permitAll()
				.antMatchers("/dashboard", "/dashboard/*").permitAll()
				.antMatchers("/dashboardGeneral", "/dashboardGeneral/*").permitAll()
				.antMatchers("/dashboardMonthly", "/dashboardMonthly/*").permitAll()
